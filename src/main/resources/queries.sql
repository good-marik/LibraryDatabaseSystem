...
insert into Person(name, yearofbirth) values('Marat Khusniyarov', 1979);
insert into Person(name, yearofbirth) values('Robert Meyer', 1964);
insert into Person(name, yearofbirth) values('Anna Ley', 1984);
insert into Person(name, yearofbirth) values('Darth Vader', 1977);
